...
* In both hourly and longitude-based time zones, there is a limit to their usefulness at the poles. Beyond 80 degrees north or south, the definition uses UTC (East00 or Narrow00E). This boundary is the only reason to include latitude in the computation of the time zone.
